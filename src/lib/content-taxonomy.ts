...
export const COLUMNS: ColumnDef[] = [
  ...
  { slug: 'education-matters-montgomery', label: 'Education Matters — Montgomery County', vertical: 'school-zone',
    description: 'Superintendent’s monthly message for Montgomery Public Schools. Selecting this column auto-loads district branding + the superintendent bio/photo; editor only writes this month’s title, body, and optional sponsor.' },
  { slug: 'education-matters-pike-road', label: 'Education Matters — Pike Road',        vertical: 'school-zone',
    description: 'Superintendent’s monthly message for Pike Road Schools. Selecting this column auto-loads district branding + Dr. Jason Goodwin’s bio and photo.' },
  { slug: 'education-matters-elmore', label: 'Education Matters — Elmore County',     vertical: 'school-zone',
    description: 'Superintendent’s monthly message for Elmore County Schools. Selecting this column auto-loads district branding + the superintendent bio/photo.' },
  { slug: 'education-matters-autauga', label: 'Education Matters — Autauga County',   vertical: 'school-zone',
    description: 'Superintendent’s monthly message for Autauga County Schools. Selecting this column auto-loads district branding + the superintendent bio/photo.' },
