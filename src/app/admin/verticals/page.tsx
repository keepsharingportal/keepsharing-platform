    ...
    <div className="flex-1 overflow-y-auto p-6 space-y-6">
      ...
      {rows.length === 0 ? (
        <div className="rounded-xl border border-dashed border-gray-200 p-12 text-center bg-white">
          ...
          <p className="text-sm font-semibold text-gray-700">No verticals yet</p>
          <p className="text-xs text-gray-500 mt-1">Run migration 069 in Supabase SQL editor to seed the first two.</p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                <div className="relative aspect-[16/7] bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                  ...
                  <span className="absolute top-3 left-3 text-[10px] font-bold uppercase tracking-widest bg-white/90 text-gray-700 px-2 py-0.5 rounded backdrop-blur-sm">
                ...
                <div className="p-4">
                  ...
                  {v.subtitle && (
                    <p className="text-xs text-gray-500 leading-snug line-clamp-2 mb-3">{v.subtitle}</p>
                  )}
                  ...
                  <div className="flex flex-wrap gap-1.5 text-[10px] font-semibold">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-gray-100 text-gray-600 hover:bg-gray-200"
                    >
