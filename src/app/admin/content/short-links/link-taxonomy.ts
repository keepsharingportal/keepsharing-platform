...
export const PURPOSES: Record<Purpose, PurposeDef> = {
  ...
  ad: {
    ...
    icon:             Megaphone,
    badgeClass:       'bg-portal-amber text-white',
    defaultUtmMedium: 'ad',
  },
  campaign: {
    value:            'campaign',
    ...
    icon:             Sparkles,
    badgeClass:       'bg-portal-blue text-white',
...
export const CHANNELS: Record<Channel, ChannelDef> = {
  print: {
    ...
    icon:       Printer,
    badgeClass: 'bg-portal-row-hover text-portal-text ring-1 ring-gray-200',
    utmSource:  'magazine',
    utmMedium:  'qr',
    worksWith:  ['qr'],
  },
  on_site: {
    ...
    label:      'On-Site Ad',
    icon:       Layout,
    badgeClass: 'bg-portal-amber-lt text-portal-amber ring-1 ring-portal-amber/30',
    utmSource:  'site',
    utmMedium:  'ad',
    worksWith:  ['ad'],
  },
  meta: {
    ...
    icon:       Share2,
    badgeClass: 'bg-portal-blue-lt text-portal-navy ring-1 ring-portal-blue/30',
    utmSource:  'meta',
    utmMedium:  'social',
    worksWith:  ['campaign'],
  },
  tiktok: {
    ...
    label:      'TikTok',
    icon:       Music2,
    badgeClass: 'bg-portal-row-hover text-portal-text ring-1 ring-slate-200',
    utmSource:  'tiktok',
    utmMedium:  'social',
    worksWith:  ['campaign'],
  },
  email: {
    ...
    icon:       Mail,
    badgeClass: 'bg-portal-green-lt text-portal-green ring-1 ring-portal-green/30',
  ...
  landing_page: {
    ...
    label:      'Landing Page',
    icon:       Globe,
    badgeClass: 'bg-portal-blue-lt text-portal-blue ring-1 ring-portal-blue/30',
    utmSource:  'landing',
    utmMedium:  'referral',
    worksWith:  ['campaign'],
  },
  other: {
    ...
    label:      'Other',
    icon:       Tag,
    badgeClass: 'bg-portal-row-hover text-portal-sub ring-1 ring-gray-200',
    utmSource:  'other',
    utmMedium:  'referral',
    worksWith:  'any',
  },
