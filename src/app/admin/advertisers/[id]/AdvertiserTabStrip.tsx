...
import { Home, Megaphone, BookOpen, BarChart3, FileText, MapPin, Sparkles } from 'lucide-react'
...
export function AdvertiserTabStrip({ id, counts }: {
  ...
  const tabs: Tab[] = [
    ...
    { href: () => `${base}/onboarding`,  match: p => p.startsWith(`${base}/onboarding`), label: 'Onboarding', icon: <Sparkles size={13} /> },
